...
โปรเจคต์นี้ แจ้งเตือนแก๊สรั่วไหลและไฟไหม้ โดยใช้ เซนเซอร์ **MQ-6** สำหรับตรวจจับแก๊สไวไฟ เซนเซอร์ **MQ-2** สำหรับตรวจจับแก๊สไวไฟและควัน ร่วมกับ **DHT11** สำหรับตรวจวัดอุณหภูมิและความชื้น ระบบจะส่งสัญญาณเสียงหรือไฟแจ้งเตือนเมื่อค่าที่ตรวจวัดเกินเกณฑ์ ช่วยป้องกันอันตรายจากการระเบิดและไฟไหม้ 
